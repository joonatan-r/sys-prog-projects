...
801040da:	68 98 75 10 80       	push   $0x80107598
...
801042f5:	68 a3 75 10 80       	push   $0x801075a3
801042fa:	e8 91 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
801042ff:	83 ec 0c             	sub    $0xc,%esp
80104302:	68 ba 75 10 80       	push   $0x801075ba
...
801043e7:	68 c1 75 10 80       	push   $0x801075c1
...
8010443c:	68 c9 75 10 80       	push   $0x801075c9
...
801047ac:	e8 9f ff ff ff       	call   80104750 <argint>
801047b1:	83 c4 10             	add    $0x10,%esp
801047b4:	85 c0                	test   %eax,%eax
801047b6:	78 28                	js     801047e0 <sys_getreadcount+0x40>
    return -1;
  if (n > 0)
801047b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047bb:	85 c0                	test   %eax,%eax
801047bd:	7e 11                	jle    801047d0 <sys_getreadcount+0x30>
    readcount = 0;
801047bf:	c7 05 bc a5 10 80 00 	movl   $0x0,0x8010a5bc
801047c6:	00 00 00 
...
801047d0:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
801047d5:	c9                   	leave  
801047d6:	c3                   	ret    
...
8010480c:	e8 3f ff ff ff       	call   80104750 <argint>
...
8010485d:	e8 ee fe ff ff       	call   80104750 <argint>
...
80104872:	e8 69 fe ff ff       	call   801046e0 <fetchstr>
...
801048a7:	83 fa 15             	cmp    $0x15,%edx
801048aa:	77 24                	ja     801048d0 <syscall+0x40>
801048ac:	8b 14 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%edx
801048b3:	85 d2                	test   %edx,%edx
801048b5:	74 19                	je     801048d0 <syscall+0x40>
    if (num == SYS_read)
801048b7:	83 f8 05             	cmp    $0x5,%eax
801048ba:	75 07                	jne    801048c3 <syscall+0x33>
      readcount++;
801048bc:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
    curproc->tf->eax = syscalls[num]();
801048c3:	ff d2                	call   *%edx
801048c5:	8b 53 18             	mov    0x18(%ebx),%edx
801048c8:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
801048cb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801048ce:	c9                   	leave  
801048cf:	c3                   	ret    
    cprintf("%d %s: unknown sys call %d\n",
801048d0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
801048d1:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
801048d4:	50                   	push   %eax
801048d5:	ff 73 10             	pushl  0x10(%ebx)
801048d8:	68 d1 75 10 80       	push   $0x801075d1
801048dd:	e8 7e bd ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
801048e2:	8b 43 18             	mov    0x18(%ebx),%eax
...
80104a34:	68 78 76 10 80       	push   $0x80107678
...
80104a4c:	68 77 76 10 80       	push   $0x80107677
...
80104a65:	68 6b 76 10 80       	push   $0x8010766b
...
80104a7a:	68 7a 76 10 80       	push   $0x8010767a
80104a7f:	e8 0c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a84:	83 ec 0c             	sub    $0xc,%esp
80104a87:	68 5c 76 10 80       	push   $0x8010765c
...
80104ab2:	e8 99 fc ff ff       	call   80104750 <argint>
...
80104b7d:	e8 ce fb ff ff       	call   80104750 <argint>
...
80104bed:	e8 5e fb ff ff       	call   80104750 <argint>
...
80104e3f:	e8 0c fa ff ff       	call   80104850 <argstr>
...
80104e79:	58                   	pop    %eax
80104e7a:	5a                   	pop    %edx
80104e7b:	68 78 76 10 80       	push   $0x80107678
...
80104e94:	68 77 76 10 80       	push   $0x80107677
...
80104eee:	e8 5d f5 ff ff       	call   80104450 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010501f:	e8 2c f8 ff ff       	call   80104850 <argstr>
...
80105038:	e8 13 f7 ff ff       	call   80104750 <argint>
...
80105184:	e8 c7 f6 ff ff       	call   80104850 <argstr>
...
801051f9:	e8 52 f5 ff ff       	call   80104750 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010520e:	e8 3d f5 ff ff       	call   80104750 <argint>
     argint(1, &major) < 0 ||
...
8010527d:	e8 ce f5 ff ff       	call   80104850 <argstr>
...
80105325:	e8 26 f5 ff ff       	call   80104850 <argstr>
...
80105341:	e8 0a f4 ff ff       	call   80104750 <argint>
...
80105366:	e8 e5 f0 ff ff       	call   80104450 <memset>
...
80105388:	e8 53 f3 ff ff       	call   801046e0 <fetchstr>
...
801053b0:	e8 eb f2 ff ff       	call   801046a0 <fetchint>
...
801055d0:	68 80 4c 11 80       	push   $0x80114c80
...
801055dd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801055e0:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  while(ticks - ticks0 < n){
...
801055f3:	68 80 4c 11 80       	push   $0x80114c80
801055f8:	68 c0 54 11 80       	push   $0x801154c0
801055fd:	e8 7e e7 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
80105602:	a1 c0 54 11 80       	mov    0x801154c0,%eax
...
80105620:	68 80 4c 11 80       	push   $0x80114c80
...
80105643:	68 80 4c 11 80       	push   $0x80114c80
...
80105664:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105667:	68 80 4c 11 80       	push   $0x80114c80
8010566c:	e8 cf ec ff ff       	call   80104340 <acquire>
  xticks = ticks;
80105671:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  release(&tickslock);
80105677:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
...
801056fe:	00 00 ef 
  initlock(&tickslock, "time");
80105701:	68 bd 76 10 80       	push   $0x801076bd
...
8010587d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105880:	e8 0b f0 ff ff       	call   80104890 <syscall>
    if(myproc()->killed)
...
80105927:	68 c8 76 10 80       	push   $0x801076c8
...
801059c5:	68 ec 76 10 80       	push   $0x801076ec
801059ca:	e8 91 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059cf:	83 c4 14             	add    $0x14,%esp
801059d2:	68 c2 76 10 80       	push   $0x801076c2
...
80105acc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105acf:	bb e4 77 10 80       	mov    $0x801077e4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801066dd:	68 ec 77 10 80       	push   $0x801077ec
...
801069b9:	68 31 78 10 80       	push   $0x80107831
...
80106b1d:	68 69 78 10 80       	push   $0x80107869
...
80106b53:	68 81 78 10 80       	push   $0x80107881
...
80106e19:	68 d2 78 10 80       	push   $0x801078d2
80106e1e:	e8 6d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e23:	83 ec 0c             	sub    $0xc,%esp
80106e26:	68 b8 78 10 80       	push   $0x801078b8
